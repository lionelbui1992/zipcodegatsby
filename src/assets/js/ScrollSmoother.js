...
class x {
    constructor(u) {
        ...
        let m, v, y, w, b, C, _, E, P, R, k, A, N, M, z, F, {
            smoothTouch: L,
            onUpdate: B,
            onStop: H,
            smooth: O,
            ...
            W = u.effectsPrefix || "",
            D = l.getScrollFunc(r),
            j = 1 === l.isTouch ? !0 === L ? .8 : parseFloat(L) || 0 : 0 === O || !1 === O ? 0 : parseFloat(O) || .8,
            Y = j && +u.speed || 1,
            K = 0,
            $ = 0,
            G = 1,
        ...
        ue.forEach(e => e.revert(!0, !0)), w = l.create({
            ...
            debounce: !0,
            content: !j && m
        } : U)), l.config(u), "overscrollBehavior" in r.getComputedStyle(i) && e.set([i, s], {
