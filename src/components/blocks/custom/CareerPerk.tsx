...
import { ICareerPerkProps } from "../types";

export const CareerPerk = ({ attributes }: { attributes: ICareerPerkProps }): JSX.Element => {
    const { title, description, peoples, background } = attributes;
    useEffect(() => {
    ...
    return (
        <>
            {(title || peoples) &&
                ...
                style={{ backgroundImage: `url(${ background ? background.src : ''})` }}>
                    <div className="container">
                        <div className="career-perk-wrapper our-teams-wrapper">
                            {(title || description) &&
